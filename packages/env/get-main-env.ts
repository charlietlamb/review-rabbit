...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_STRIPE_PLAN_PRICE_ID_YEARLY:
      process.env.NEXT_PUBLIC_STRIPE_PLAN_PRICE_ID_YEARLY,
    NEXT_PUBLIC_STRIPE_PLAN_PRICE_ID_PRO:
      process.env.NEXT_PUBLIC_STRIPE_PLAN_PRICE_ID_PRO,
    NEXT_PUBLIC_STRIPE_PLAN_PRICE_ID_PRO_YEARLY:
      process.env.NEXT_PUBLIC_STRIPE_PLAN_PRICE_ID_PRO_YEARLY,
